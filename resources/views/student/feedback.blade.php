...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col py-8 px-4 min-h-screen">
        <nav class="flex-1">
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('student.dashboard') }}" class="flex items-center px-3 py-2 rounded-lg text-gray-700 hover:bg-gray-100">
                ...
                <li>
                    <a href="{{ route('student.feedback') }}" class="flex items-center px-3 py-2 rounded-lg bg-blue-100 text-blue-700 font-semibold">
    ...
    <main class="flex-1 max-w-3xl mx-auto mt-10 p-6">
        <h1 class="text-2xl font-bold mb-6">Feedback primit</h1>
        <div class="bg-white rounded-xl shadow p-6">
            @if($feedbacks->count() === 0)
                <div class="text-gray-400 text-center py-8">Nu ai primit încă feedback la nicio lucrare.</div>
            @else
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2">{{ $fb->teacher->name ?? '-' }}</td>
