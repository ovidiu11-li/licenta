...
// rutele adminului - doar admin
Route::prefix('admin')->middleware(['auth', \App\Http\Middleware\CheckUserRole::class . ':admin'])->group(function () {
...
// rutele profesorului - doar profesor
Route::prefix('teacher')->middleware(['auth', \App\Http\Middleware\CheckUserRole::class . ':teacher'])->group(function () {
...
// rutele studentului - doar student
Route::prefix('student')->middleware(['auth', \App\Http\Middleware\CheckUserRole::class . ':student'])->group(function () {
...
// rutele partajate de pdf-uri - accesibile tuturor utilizatorilor autentificați
